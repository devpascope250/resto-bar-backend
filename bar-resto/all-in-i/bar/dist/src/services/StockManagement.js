...
class StockManagement extends ApiService_1.ApiService {
    constructor(headers) {
        ...
        this.currentStock = async (itemCd, type) => {
            ...
            const productsWithQuantity = getproducts.map(product => {
                var _a, _b;
                {
                    ...
                    return {
                        ...
                        currentStock: type === "IN" ? product.currentStock + ((_a = item === null || item === void 0 ? void 0 : item.quantity) !== null && _a !== void 0 ? _a : 0) : product.currentStock - ((_b = item === null || item === void 0 ? void 0 : item.quantity) !== null && _b !== void 0 ? _b : 0)
                    };
                }
            });
            return productsWithQuantity;
        };
        this.createStockIn = async (ItemDt, stockinType, LatestSaleTraId) => {
            ...
            const stockInData = {
                sarNo: LatestSaleTraId,
                orgSarNo: LatestSaleTraId,
                regTyCd: 'A',
                custTin: null,
                custNm: null,
                custBhfId: null,
                ...
                totTaxAmt: Number(TotalTaxAmount.toFixed(2)),
                totAmt: TotalAmount,
                remark: null,
                regrNm: "admin",
                regrId: "admin",
        ...
        this.createStockOut = async (ItemDt, stockinType, LatestSaleTraId) => {
            ...
            const stockInData = {
                sarNo: LatestSaleTraId + 1,
                orgSarNo: LatestSaleTraId + 1,
                regTyCd: 'A',
                custTin: null,
                custNm: null,
                custBhfId: null,
        ...
        // create stock master
        this.saveStockMaster = async (items, type) => {
            const getcurrentStock = await this.currentStock(items, type);
        ...
        this.createStockInOfImport = async (ItemDt, stockinType, LatestSaleTraId) => {
            ...
            for (const [index, item] of ItemDt.entries()) {
                ...
                const stockInData = {
                    sarNo: LatestSaleTraId + index + 1,
                    orgSarNo: LatestSaleTraId + index + 1,
                    regTyCd: 'A',
                    custTin: null,
                    custNm: null,
                    custBhfId: null,
                    ...
                    itemList: [{
                            ...
                            taxAmt: (_1 = Number(TotalTaxAmount.toFixed(2))) !== null && _1 !== void 0 ? _1 : 0,
        ...
        this.createStockInOfPurchase = async (item, stockinType, LatestSaleTraId) => {
