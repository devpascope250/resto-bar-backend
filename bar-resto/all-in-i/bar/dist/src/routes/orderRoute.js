...
// // change order status
router.put('/orders/status', (0, authMiddleware_1.authMiddleware)(['MANAGER', "PARTNER_ADMIN"]), orderController.changeOrderStatus);
// // get order by id
router.get('/orders/:orderId', (0, authMiddleware_1.authMiddleware)(['MANAGER', 'WAITER', "CHEF", "PARTNER_ADMIN"]), orderController.getOrderDetails);
// get order stats
