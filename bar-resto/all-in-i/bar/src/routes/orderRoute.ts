...
router.get('/orders/chef', authMiddleware(['MANAGER','CHEF','WAITER','KITCHEN',"PARTNER_ADMIN"]), orderController.getChefAllOrders);
// get orders by other
...
router.post('/orders/change-item-status', authMiddleware(['MANAGER','CHEF']), orderController.changeOrderItemStatus);
